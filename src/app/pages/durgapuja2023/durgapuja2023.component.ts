...
@Component({
  selector: 'app-durgapuja2023',
  templateUrl: './durgapuja2023.component.html',
  styleUrls: ['./durgapuja2023.component.scss']
})
export class Durgapuja2023Component implements OnInit {
